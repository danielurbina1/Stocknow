...
const Pasillos = () => {
  ...
  return (
    <nav class=" h-screen   top-50 left-10 min-w-[250px] py-6 px-4 font-[sans-serif] hidden sm:block">
      <div class="overflow-auto py-6 h-full mt-4">
        <ul class="space-y-1">
          <li>
            <a
              href="javascript:void(0)"
              class=" hover:text-blue-600 text-[15px] flex items-center hover:bg-white rounded px-4 py-3 transition-all"
            >
              <svg
          ...
          <li>
            ...
            >
              ...
              <span className="text-xl">Internacional</span>
            </a>
          </li>
          <li>
            <a
          ...
          <li>
            ...
            >
              ...
              <span className="text-xl">Conservas</span>
            </a>
          </li>
          <li>
            <a
            ...
            >
              ...
              <span className="text-xl">Salsas</span>
            </a>
          </li>
          <li>
            <a
            ...
            >
              ...
              <span className="text-xl">Bolleria</span>
            </a>
          </li>
          <li>
            <a
            ...
            >
              ...
              <span className="text-xl">Frutos secos</span>
            </a>
          </li>
        </ul>
      </div>
